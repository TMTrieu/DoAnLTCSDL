    ...
    public class YeuCauThoiViecBL
    {
        ...
        public int GuiYeuCauVaLayId(YeuCauThoiViec yeuCau)
        {
            try
            {
                ...
                // GỌI AI
                var classifier = new MLModel.ThoiViecClassifier();
                string loaiLyDo = classifier.Predict(yeuCau.LyDo);        // CaNhan / CongViec / MauThuan
                yeuCau.LoaiLyDo = loaiLyDo;                           // thêm cột, hoặc ghi chú
                yeuCau.GhiChu = $"AI: {loaiLyDo}";
