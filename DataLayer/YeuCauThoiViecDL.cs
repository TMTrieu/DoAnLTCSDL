...
namespace DataLayer
{
    public class YeuCauThoiViecDL: DataProvider
    {
        public List<YeuCauThoiViec> GetYeuCaus()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    YeuCauThoiViec yeucau = new YeuCauThoiViec(idYC,idNV, ngayYC, lyDo, trangThai, ngayPD, ghiChu);
        ...
        public bool AddYeuCau(YeuCauThoiViec yc)
        {
            ...
            string sql = @"INSERT INTO YeuCauThoiViec (IdYeuCau, IdNhanVien, NgayYeuCau, LyDo, TrangThai, NgayPheDuyet, GhiChu)
                           VALUES (" + yc.IdYeuCau + "," + yc.IdNhanVien + ", '" + yc.NgayYeuCau.ToString("yyyy-MM-ddTHH:mm:ss") + "',N'" + yc.LyDo + "',N'" + yc.TrangThai + "', NULL, NULL);" +
        ...
        {
            string sql = "DELETE FROM YeuCauThoiViec WHERE IdYeuCau = " + id;
