...
namespace PresentationLayer.ChamCong
{
    public partial class FormNgayCongChiTiet : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btCapNhat_Click(object sender, EventArgs e)
        {
            ...
            //if (chCbBLoaiCa.EditValue == null || string.IsNullOrEmpty(chCbBLoaiCa.EditValue.ToString()))
            if (listCa.Count == 0)
            {
            ...
            /*LoaiCa ca = loaiCaBL.GetLoaiCas().FirstOrDefault(x => x.TenLoaiCa == chCbBLoaiCa.EditValue.ToString());
            if (ca != null)
                bangCongMoi.IdLoaiCa = ca.IdLoaiCa;
            else
                bangCongMoi.IdLoaiCa = Convert.ToInt32(chCbBLoaiCa.EditValue);*/
