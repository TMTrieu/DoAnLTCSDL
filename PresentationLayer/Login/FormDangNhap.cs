        ...
        private void btLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (taiKhoan != null)
                {
                    ...
                    this.IdNhanVien = taiKhoan.IdNhanVien;
                    //MessageBox.Show("IdNhanVien sau đăng nhập: " + this.IdNhanVien);

                    // Truyền giá trị IdNhanVien sang FormUser
                    FormUser formUser = new FormUser(this.IdNhanVien);
                    formUser.Show();
                    this.Hide();  // Ẩn FormDangNhap sau khi đăng nhập thành công
